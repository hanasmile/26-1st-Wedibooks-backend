...
CSV_PATH_MENU = './menu.csv'
CSV_PATH_CATEGORY = './category.csv'
CSV_PATH_SUBCATEGORY = './subcategory.csv'
...
with open(CSV_PATH_SUBCATEGORY) as in_file:
    ...
    for row in data_reader:
        ...
        subcategory_category = row[1]

        Subcategory.objects.create(name = subcategory_name, category_id = subcategory_category)
